...
function createDummySocketService() {
  ...
  const socketService = {
    ...
    emit(eventName, data) {
      ...
      if (eventName === SOCKET_EMIT_TYPING) {
        // Emit the typing status to all listeners
        listeners = listenersMap[SOCKET_EVENT_TYPING]
      }
    ...
    testTypingNotification() {
      this.emit(SOCKET_EVENT_TYPING, { isTyping: true, user: 'User 1' })
    }
  }
